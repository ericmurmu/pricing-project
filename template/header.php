...
<!--"./Pricing example · Bootstrap v5.2_files/bootstrap.min.css"-->
<!--"../asset/bootstrap.min.css"[while running main.php file] -->
<!-- "./asset/bootstrap.min.css" [while running index.php file] -->
...
<meta name="theme-color" content="#712cf9">
    ...
    <!--"./Pricing example · Bootstrap v5.2_files/pricing.css"-->
    <link href="./Pricing example · Bootstrap v5.2_files/pricing.css" rel="stylesheet">
  </head>
